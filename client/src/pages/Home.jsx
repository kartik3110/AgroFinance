...
const Home = () => {
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section className="my-28 bg-hero-pattern bg-cover bg-center h-screentext-white">
        <div className="flex justify-around">
          <div className="w-1/2 flex flex-col justify-center">
            <h1 className=" text-6xl font-bold mb-4">
              Empowering Farmers: Zero-Collateral Lending
            </h1>
            <Text className="mb-8" size="3xl">
              Flexible, affordable loans tailored to the needs of farmers, with
              no collateral required.
            </Text>
            <div className="flex space-x-4">
              <Button shape="round">
                <a className="font-bold" href="#how-it-works">
                  Learn More
                </a>
              </Button>
      ...
      <Divider />
      {/* Problem Statement */}
      <section className="py-16 px-4 md:px-16text-center">
        <div className="flex justify-around">
          <img
      ...
      <section id="how-it-works" className="py-16 px-4 md:px-16 ">
        <h1 className="text-4xl font-bold mb-8 text-center">
          How Our Platform Works
        </h1>
        <div className="h-96">
          <Carousel showThumbs={false} className="w-1/2 mx-auto h-48">
            <div className="flex gap-8 justify-around">
              <div className="flex flex-col justify-center">
                <h3 className="text-xl font-semibold">1. Farmers Apply</h3>
                <p className="mt-4">
            ...
            <div className="flex justify-around">
              <div className="flex flex-col justify-center">
                <h3 className="text-xl font-semibold">2. Farmers Apply</h3>
                <p className="mt-4">
                  Farmers register and apply for loans based on their needs.
                </p>
              </div>
            ...
            <div className="flex justify-around">
              <div className="flex flex-col justify-center">
                <h3 className="text-xl font-semibold">3. Farmers Apply</h3>
                <p className="mt-4">
                  Farmers register and apply for loans based on their needs.
                </p>
              </div>
            ...
            <div className="flex justify-around">
              <div className="flex flex-col justify-center">
                <h3 className="text-xl font-semibold">4. Farmers Apply</h3>
                <p className="mt-4">
                  Farmers register and apply for loans based on their needs.
                </p>
              </div>
      ...
      <section className="py-16 px-4 md:px-16 text-center">
        ...
        <div className="flex justify-center gap-16">
          <div class="block max-w-xs p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
      ...
      <section
        id="get-started"
        className="py-16 px-4 md:px-16 text-white text-center"
      >
        <h1 className="text-3xl font-semibold mb-8">Ready to Get Started?</h1>
        <p className="text-lg mb-8">
          Join the platform and help revolutionize agricultural finance today.
        </p>
        <a
          href="#"
          className="px-8 py-4 underline bg-white rounded-lg font-semibold "
        >
          Sign Up Now
        </a>
      </section>
